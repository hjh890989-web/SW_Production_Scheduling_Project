# 사내 생산 스케줄링 시스템 — PRD v1.3

| 항목 | 내용 |
|---|---|
| 문서명 | PRD — 통합 요구사항 명세서 |
| 문서 번호 | 18 |
| 버전 | **v1.3** (VPS↔PRD 매핑 갭 보강 — Competitor + Value Proposition) |
| 최종 업데이트 | 2026-05-10 |
| Owner 팀 | 경영기획 본부 |
| 문서 성격 | **AI 페어 코딩 직접 구현용 PRD** (외주용 RFP 아님) |
| 입력 자료 | 개발계획서 #4 / 문제정의서 #6 / 페르소나 #8 / 여정맵 #9 / JTBD #10 / VPS #13 / PRD v1.0 #15 / v1.1 #16 / v1.2 #17 |
| 다음 산출물 | 와이어프레임 (선택) 또는 Sprint 0 코드 시작 |
| v1.2 → v1.3 변경 | **VPS↔PRD 매핑 갭 보강**: ① **§1.1 한 줄 가치 제안** 신설 (VPS 인용) ② **§5.0 대안 비교 (Competitor/Substitute) 신설** — 4가지 대안 표 + 성능/보안/비용 기준선. 매핑 점수 약 87% → 약 97% |
...
| **v1.3 (#18)** | **2026-05-10** | **VPS↔PRD 매핑 갭 보강**: ① §1.1 **한 줄 가치 제안** 신설 (Pain→Mechanism→Outcome 구조 명시) — §1.2~1.5 후속 번호 재조정 / ② §5.0 **대안 비교(Competitor/Substitute) 신설** — 4가지 대안 표(13 차원), 성능·보안·비용 기준선, 대안별 결론, 핵심 차별 4요인. **VPS↔PRD 매핑 점수 약 87% → 약 97%** | 경영기획 본부 |
